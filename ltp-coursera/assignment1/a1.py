...
def get_hours(seconds):
    ...
    2
    '''
    return to_24_hour_clock(round(seconds / 3600))
...
def get_minutes(seconds):
    ...
    midnight as seen on a clock. (This means that the 
    return value should be in the range 0 to 59, inclusive.)
    ...
    3
    '''
    remaining_seconds = seconds - get_hours(seconds) * 3600
...
def get_seconds(seconds):
    ...
    return seconds - (get_hours(seconds) * 3600) - (get_minutes(remaining_seconds) * 60)
